...
SPACES_MODEL_KEY = os.environ.get("SPACES_MODEL_KEY", "models/latest/model.pkl")
...
def download_model():
    ...
    s3.download_file(SPACES_BUCKET, SPACES_MODEL_KEY, MODEL_PATH)
    print(f"Model downloaded from s3://{SPACES_BUCKET}/{SPACES_MODEL_KEY}.")
